...
f.each_line do |line|
  ...
  if line =~ /<routes/
    ...
    fo.write('    <vType id="CarA" carFollowModel="IIDM" length="5.0" color="0,1,0" accel="1.5" decel="2" tau="1.1" sigma="0.0" impatience="0.0" minGap="0.5" maxSpeed="70.0"/>')
    fo.write("\n")
    ...
    fo.write('    <vType id="CarM" carFollowModel="IIDM" length="5.0" color="0,0,1" accel="1.5" decel="2" tau="2.05" sigma="0.0" impatience="0.0" minGap="2.0" maxSpeed="70.0"/>')
    fo.write("\n")
  elsif line =~  /id="(.*)"/
